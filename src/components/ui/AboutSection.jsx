  ...
  return (
    <ReactLenis root>
      <main className="bg-black md:-mt-48">
            ...
            <div className="sticky top-0 h-screen grid place-content-center">
              ...
              >
                <h1 className="text-3xl md:text-4xl px-8 font-medium text-center tracking-tight leading-[120%]">
                  Why Choose <br />{" "}
                  <span className="text-blue-400">Alhena Ventures</span>
                </h1>
                <p className="mt-6 text-gray-400 text-center max-w-xs mx-auto">
                  We deliver exceptional results with a focus on quality,
        ...
        <footer className="group bg-slate-950 -mt-44 relative">
          <motion.h1
          ...
          <div className="bg-[#4ac0fa] h-40 relative z-10 grid place-content-center text-2xl rounded-tr-full rounded-tl-full">
            {/* Social Media and Copyright */}
            <div className="bg-[#4ac0fa] relative z-10 rounded-tr-full rounded-tl-full">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                  <div className="text-white font-medium">
                    © {new Date().getFullYear()} Alhena Ventures. All rights
                    reserved.
                  </div>
